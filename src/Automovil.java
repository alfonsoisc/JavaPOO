public class Automovil implements Comparable<Automovil>{
    ...
    private int id;
     ...
     public static final String COLOR_GRIS = "Gris Orcuro";
    ...
    public float calcularConsumo(int km, float porcentajeGas){
        return km/(this.getEstanque().getCapacidad() *porcentajeGas);
    }

    public float calcularConsumo(int km, int porcentajeGas){
        return km/(this.getEstanque().getCapacidad()*(porcentajeGas/100f));
    }

    public static float calcularConsumoEstatico(int km, int porcentajeGas){
        return km/(capacidadTanqueEstatico*(porcentajeGas/100f));
    }
    @Override
    ...
    public String toString() {
        return this.id +"  :  "+ "Automovil{" +
                "fabricante='" + fabricante + '\'' +
                ", modelo='" + modelo + '\'' +
                ", color='" + this.color.getColor() + '\'' +
                ", cilindrado=" + motor  +
                ", capacidadTanque=" + estanque +
                '}';
    }
